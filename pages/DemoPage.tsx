    ...
    return (
        <div className="pt-32 pb-20 min-h-screen bg-background flex items-center justify-center">
            <div className="max-w-xl w-full mx-auto px-6">
                <div className="bg-white rounded-3xl p-10 shadow-card border border-black/5">
                    ...
                    <form className="space-y-6">
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" className="w-full px-4 py-3 bg-surface border border-transparent rounded-xl focus:border-accent-primary focus:bg-white outline-none transition-all" />
                            </div>
                            <div>
                        ...
                        <div>
                            ...
                            <input type="email" className="w-full px-4 py-3 bg-surface border border-transparent rounded-xl focus:border-accent-primary focus:bg-white outline-none transition-all" />
                        </div>
                        <div>
                            <label className="block text-sm font-medium text-textMain mb-2">Firm Size</label>
                            <select className="w-full px-4 py-3 bg-surface border border-transparent rounded-xl focus:border-accent-primary focus:bg-white outline-none transition-all appearance-none cursor-pointer">
